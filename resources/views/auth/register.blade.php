      ...
      <div class="w3l-contact-10 py-5" id="contact">
          ...
          <div class="container">
            <div class="contacts-5-grid-main mt-4">
              <div class="header-title text-center mx-auto">
                <h3 class="title-w3l">Register</h3>
                <p class="mt-3">Create An Account To Get Started</p>
              </div>
              <div>
        ...
        <form method="POST" action="{{ route('register') }}" class="signin-form">
            @csrf
                  ...
                  <div class="mt-4 w-100 form-item">
                  ...
                  <div class="form-input mt-4" data-aos="fade-down">
                    <input
                      type="password"
                      name="password"
                      class="form-control"
                  ...
                  <div class="text-center mt-4">
                    <button class="btn btn-style btn-primary" type="submit">Submit Now</button>
                  </div>
